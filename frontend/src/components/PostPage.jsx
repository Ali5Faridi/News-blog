...
//     try {
//       const localDate = new Date(postInfo.createdAt);
//       formattedDate = format(localDate, 'MMMM dd, yyyy HH:mm'); // فرمت دلخواه
//     } catch (error) {
...
//       <div className="author">Author: {postInfo.author?.username || 'Unknown author'}</div>
//       <div className="image">
